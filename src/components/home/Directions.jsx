...
import { mainPageDirections } from "../../data/directionsData"
    ...
    <section className="py-20 px-4 bg-gray-50">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-bold mt-2 gradient-text">
            Qaysi sohani o'rganasiz?
          </h2>
          <p className="text-gray-600 mt-4 max-w-2xl mx-auto">
            Zamonaviy IT sohalari bo'yicha mutaxassislardan bepul ta'lim oling
          </p>
        </motion.div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {mainPageDirections.map((direction, index) => (
            <motion.div
              key={direction.id}
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-r from-primary to-secondary rounded-2xl blur-xl opacity-0 group-hover:opacity-20 transition-opacity duration-300" />
        ...
        >
          <Link
            to="/directions"
            className="inline-flex items-center gap-2 px-8 py-3 bg-gradient-to-r from-primary to-secondary  rounded-lg  hover:text-[#10B981] hover:border-[#10B981] font-semibold hover:shadow-lg transition-all hover:scale-105"
          >
            Barcha yo'nalishlar
